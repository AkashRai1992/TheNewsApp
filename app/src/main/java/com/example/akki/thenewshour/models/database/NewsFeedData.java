package com.example.akki.thenewshour.models.database;
...
/**
 * This model class used to maintain recent searches.In database table it sets unique combo for entityId and UserID
 * for maintaining unique rows.
 *
 * @author Akash
 * @version 1.0
 * @since 1.0
